  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Ticket>>(
        future: _supabaseService.getMyTickets(),
            ...
            return Center(
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 16),
                  Text("No tienes boletos activos.", style: TextStyle(color: Colors.grey, fontSize: 16)),
                ],
              ),
            );
          }
                        ...
                        children: [
                          _infoRow(Icons.calendar_today, "Fecha",
                            DateFormat('EEE, d MMM y', 'es').format(
                              ticket.selectedDate ?? ticket.eventDate ?? DateTime.now()
                            )
                          ),
                          const SizedBox(height: 8),
                          _infoRow(Icons.location_on_outlined, "Ubicación", ticket.eventLocation ?? 'N/A'),
                          const SizedBox(height: 8),
                          _infoRow(Icons.people_outline, "Cantidad", "${ticket.quantity} boleto(s)"),
                          const Padding(
                                    ...
                                    child: BackdropFilter(
                                      ...
                                      child: Container(
                                        ...
                                        child: const Column(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Icon(Icons.lock_outline, size: 36, color: AppColors.primaryRed),
                                            SizedBox(height: 8),
                                            Text("Toca para\nrevelar el QR",
